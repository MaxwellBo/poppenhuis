        ...
        <section className='short'>
          ...
          <details>
            ...
            <ul>
              ...
              <li>
                Get me to edit the 1st party manifest for you by reaching out to <a href="https://twitter.com/_max_bo_">me on Twitter</a> and sendingover a <code>.zip</code> folder of your models and a Google Sheet of your metadata.
              </li>
            </ul>
          </details>
          <details>
